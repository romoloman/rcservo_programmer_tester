...
void create_screen_main() {
    ...
    lv_obj_set_style_margin_right(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_add_event_cb(obj, action_load_programmer, LV_EVENT_CLICKED, (void *)0);
            lv_obj_set_style_bg_color(obj, lv_color_hex(0xff000000), LV_PART_MAIN | LV_STATE_DEFAULT);
            ...
            lv_obj_set_style_shadow_ofs_y(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                lv_obj_t *parent_obj = obj;
                {
                    ...
                    lv_image_set_src(obj, &img_servosettings);
                }
                {
                    ...
                    lv_label_set_text(obj, "Programmer");
                }
            }
        }
        {
            ...
            lv_obj_set_size(obj, 100, 120);
            lv_obj_add_event_cb(obj, action_load_tester, LV_EVENT_CLICKED, (void *)0);
            lv_obj_set_style_bg_color(obj, lv_color_hex(0xff000000), LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_pad_top(obj, 10, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_pad_bottom(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_pad_left(obj, 10, LV_PART_MAIN | LV_STATE_DEFAULT);
            ...
            lv_obj_set_style_shadow_ofs_y(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                lv_obj_t *parent_obj = obj;
                {
                    ...
                    lv_obj_set_pos(obj, 0, 0);
                    lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
                    lv_image_set_src(obj, &img_servotester);
                }
                {
                    lv_obj_t *obj = lv_label_create(parent_obj);
                    lv_obj_set_pos(obj, 0, 40);
        ...
        }
        {
            ...
            lv_obj_set_size(obj, 100, 120);
            lv_obj_add_event_cb(obj, action_load_meter, LV_EVENT_CLICKED, (void *)0);
            lv_obj_set_style_bg_color(obj, lv_color_hex(0xff000000), LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_pad_top(obj, 10, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_pad_bottom(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_pad_left(obj, 10, LV_PART_MAIN | LV_STATE_DEFAULT);
            ...
            lv_obj_set_style_shadow_ofs_y(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                lv_obj_t *parent_obj = obj;
                {
                    ...
                    lv_obj_set_pos(obj, 0, 0);
                    lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
                    lv_image_set_src(obj, &img_oscilloscope);
                }
                {
                    lv_obj_t *obj = lv_label_create(parent_obj);
                    lv_obj_set_pos(obj, 0, 40);
                    lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
                    lv_obj_set_style_align(obj, LV_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_label_set_text(obj, "Pulse Meter");
                }
            }
        }
    }
...
void create_screen_meter() {
    ...
    lv_obj_set_style_text_align(obj, LV_TEXT_ALIGN_RIGHT, LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_set_pos(obj, 0, 0);
            lv_obj_set_size(obj, 320, 40);
            lv_obj_set_style_bg_color(obj, lv_color_hex(0xfff00828), LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_bg_opa(obj, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_layout(obj, LV_LAYOUT_FLEX, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_flex_main_place(obj, LV_FLEX_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_flex_cross_place(obj, LV_FLEX_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
        ...
        }
        {
            // pmsetcenter_bt
            lv_obj_t *obj = lv_button_create(parent_obj);
            objects.pmsetcenter_bt = obj;
            lv_obj_set_pos(obj, 122, 47);
            lv_obj_set_size(obj, 75, 20);
            lv_obj_add_event_cb(obj, action_smstorecenter, LV_EVENT_CLICKED, (void *)0);
        ...
        }
        {
            // metermidvaluelbl
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.metermidvaluelbl = obj;
            lv_obj_set_pos(obj, 125, 75);
            lv_obj_set_size(obj, 70, LV_SIZE_CONTENT);
            lv_obj_set_style_text_font(obj, &lv_font_montserrat_26, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_text_align(obj, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_label_set_text(obj, "----");
        }
        {
            // metermaxvaluelbl
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.metermaxvaluelbl = obj;
            lv_obj_set_pos(obj, 221, 75);
            lv_obj_set_size(obj, 70, LV_SIZE_CONTENT);
            lv_obj_set_style_text_font(obj, &lv_font_montserrat_26, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_text_align(obj, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_label_set_text(obj, "----");
        }
        {
            // pmsetst_bt
            lv_obj_t *obj = lv_button_create(parent_obj);
            objects.pmsetst_bt = obj;
            lv_obj_set_pos(obj, 7, 146);
            lv_obj_set_size(obj, 89, 84);
            lv_obj_add_event_cb(obj, action_smsetservotester, LV_EVENT_CLICKED, (void *)0);
            lv_obj_set_style_radius(obj, 20, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                lv_obj_t *parent_obj = obj;
                {
                    ...
                    lv_obj_set_style_align(obj, LV_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_text_align(obj, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_label_set_text(obj, "USE VALUES IN SERVO TESTER");
                }
            }
        }
        {
            // pmreset_bt
            lv_obj_t *obj = lv_button_create(parent_obj);
            objects.pmreset_bt = obj;
            lv_obj_set_pos(obj, 110, 108);
            lv_obj_set_size(obj, 100, 25);
            lv_obj_add_event_cb(obj, action_smresetvalues, LV_EVENT_CLICKED, (void *)0);
            {
                lv_obj_t *parent_obj = obj;
                {
                    lv_obj_t *obj = lv_label_create(parent_obj);
...
void create_screens() {
    ...
    create_screen_main();
    create_screen_programmer();
    create_screen_tester();
    create_screen_meter();
}
